...
## CleanSlate AI –  Your Digital Estate Manager (Autonomous Digital Clutter Management Agent)
...
## 2. 💎 Project Identity
### Product Name: CleanSlate AI –  Your Digital Estate Manager
### Tagline: AI Chief of Staff for Digital Organization and Storage Management.
### Repository: cleanslate-ai-my-pc-assistant
### Description:
CleanSlate AI is your autonomous digital concierge — a safety‑first agent that declutters, organizes, and protects your files with precision. It classifies documents, detects sensitive data, removes duplicates, recovers storage, and keeps your PC organized using ADK 2.0, MCP tools, Pub/Sub automation, and strict HITL + rollback guarantees.
...
•	Scans local(`Current`)+ cloud storage`(Future)`  
...
**Note: Sensitive files are never deleted.**
...
**NOte: No destructive action happens without explicit approval.**
...
**NOte: Move sensitive files to authenticated folder**
...
**NOte:Future recommendations adapt automatically.**

## 7. 🛡️ Safety Rules (How the Agent Stays Safe)
...
## 11. ⚖️ Dependencies (What This Spec Relies On)
