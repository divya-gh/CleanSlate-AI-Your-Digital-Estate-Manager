---
name: git-mini
description: Safe git workflow with auto-generated meaningful ≤10 character commit messages and sensitive-file protection.
---
...
if [ ${#MSG} -gt 10 ]; then
  echo "❌ Error: Commit message must be ≤10 characters. Current length: ${#MSG}"
  exit 1
fi
